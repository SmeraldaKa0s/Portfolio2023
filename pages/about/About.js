...
const About = () => {
  const items = [
    {
      id: 1,
      name: "MARKET RESEARCH & UX RESEARCHER",
      description: "This is the first item in the list.",
      time: "2023",
    },
    {
      id: 2,
      name: "QA ANALYST & FRONTEND DEVELOPER",
          ...
          <div className={styles.centerAbout}>
            <div className={styles.aboutBox}>
              ...
              <p className={`${styles.about} ${styles.margin}`}>
                Anteriormente, tuve diversos roles que ampliaron mis perspectiva
                a la hora de desarrollar tecnologia, haber pasado por el rol de
                qa analyst, frotend development y researcher me entrenaron los
                ojos y tendieron un puente hacia la constante busqueda de mejora
                y calidad.
              </p>
              <p className={`${styles.about} ${styles.margin}`}>
              ...
              <p className={`${styles.about} ${styles.margin}`}>
                Todos estos temas tienen un impacto significativo en cómo inicio
                y desarrollo mis procesos creativos, marcando la pauta de cómo
                percibo el desarrollo web hoy en día.
              </p>
              <p className={`${styles.about} ${styles.margin}`}>
